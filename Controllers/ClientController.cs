...
namespace TireLire.Controllers
{
    ...
    public class ClientController : Controller
    {
        ...
        public ActionResult ListNote()
        {
            ...
            ViewBag.List = new List<int> { 0, 1, 2, 3, 4, 5};
            //List<SelectListItem> liste = new List<SelectListItem>();
            //liste.Add(new SelectListItem() { Text = "1", Value = "1" });
            //liste.Add(new SelectListItem() { Text = "2", Value = "2" });
            //liste.Add(new SelectListItem() { Text = "3", Value = "3" });
            //ViewBag.List = liste;
            return View();
        }
